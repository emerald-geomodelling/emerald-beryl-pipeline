...
The docs subdirectory has an example notebook that runs [processing and inversion](docs/run processing inversion luigi.ipynb], as well as an [introspection notebook](docs/run introspection.ipynb) that can be used to extract available parameters for all the processing filters as well as for the inversion function.
